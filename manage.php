...
<div class="card card-outline card-primary">
	...
	<div class="card-body">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label for="invoice_code" class="control-label">Invoice ID</label>
						...
						<div class="form-group">
							...
							<input type="text" name="subject" id="subject" value="<?php echo isset($subject) ? $subject : ''; ?>" class="form-control form-control-sm" required>
						</div>
						
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label for="inv_from" class="control-label">From</label>
							<textarea name="inv_from" id="inv_from" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($inv_from) ? $inv_from : ''; ?></textarea>
						</div>
						<div class="form-group">
							<label for="customer_name" class="control-label">For</label>
		...
		<div class="card-footer">
				<button class="btn btn-flat btn-sm btn-primary" form="invoice-form">Save & Print</button>
				<a class="btn btn-flat btn-sm btn-default" href="./?page=invoice">Close</a>
		</div>
	</div>
</div>
